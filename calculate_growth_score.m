...
function [growth_score, growth_score_ab, growth_score_a] = calculate_growth_score(no_organoids, params, params_2, error_vec_bic, error_vec_2_bic, norm_DMSO_STA, drug_numbers, plate_numbers)
